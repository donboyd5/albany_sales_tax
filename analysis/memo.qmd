...
| **Preemption comparison** | Preempting 1.5 points instead would yield \$`r fm(0.015 * est$B_c_central)` M against the \$`r fm(status_quo)` M it would forfeit — a loss of about \$`r fm(status_quo - 0.015 * est$B_c_central)` M a year |
